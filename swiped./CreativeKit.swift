...
class CreativeKit {
	...
	class func shareToPreview(clientID: String, mediaType: ShareMediaType, mediaData: Data) {
	...
	private class func createAndOpenShareUrl(clientID:String, shareDest: ShareDestination, dict:[String:Any]) {
